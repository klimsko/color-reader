...
export function colorConverter(color) {
  if (!(this instanceof colorConverter)) { return new colorConverter(color); }
...
function toColorObject(c) {
  var typ, arr = [], arrlength, i, opacity, match, a, hue, sat, rgb, colornames = [], colorhexs = [];
  c = ccTrim(c.toLowerCase());
  a = 1;
